...
$global_header_title = WDS_Options::get( 'site_info', 'campus', 'wsu' );
$title               = 'Washington State University';
$link                = 'https://wsu.edu';

switch ( $global_header_title ) {

	case 'global':
		$title = 'WSU Global Campus';
		$link  = 'https://online.wsu.edu';
		break;
	case 'spokane':
		$title = 'WSU Spokane';
		$link  = 'https://spokane.wsu.edu/';
		break;
	case 'everett':
		$title = 'WSU Everett';
		$link  = 'https://everett.wsu.edu/';
		break;

}

?>
<a class="wsu-wordmark" href="<?php echo esc_url( $link ); ?>" aria-label="Go to <?php echo esc_attr( $title ); ?> Homepage">

...
class Block_Customizer_Header_Quicklinks extends Block_Customizer {

	protected $title      = 'Header | Quicklinks';
	protected $desc       = '';
	protected $section_id = 'wsu_theme_block_header_quicklinks';

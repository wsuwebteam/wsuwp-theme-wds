...
class Block_Customizer_Navigation_Mobile extends Block_Customizer {

	protected $title      = 'Navigation | Mobile';
	protected $desc       = '';
	protected $section_id = 'wsu_theme_block_navigation_mobile';

<header class="wsu-header-unit ">
	<div class="wsu-header-unit__inner">
		<div class="wsu-header-unit__banner">
			...
			<span class="wsu-logo-lockup  wsu-logo-lockup--style-unit">
				<a class="wsu-logo-lockup__icon-wrapper" href="<?php echo esc_url( get_home_url() ); ?>" tabindex="-1" aria-hidden="true">
				...
				<span class="wsu-logo-lockup__title-wrapper">
					<a href="<?php echo esc_url( $args['subtitleLink'] ); ?>" class="wsu-logo-lockup__subtitle"><?php echo wp_kses_post( get_bloginfo( 'description' ) ); ?></a>
					<a href="<?php echo esc_url( get_home_url() ); ?>" class="wsu-logo-lockup__title"><?php echo wp_kses_post( get_bloginfo( 'name' ) ); ?></a>
				</span>
			</span>
			<?php else : ?>

		...
		<div class="wsu-header-campus__banner">
			<a href="https://pullman.wsu.edu" class="wsu-logo-lockup  wsu-logo-lockup--style-campus">
				...
				<span class="wsu-logo-lockup__title-wrapper">
					...
					<span class="wsu-logo-lockup__title">Pullman</span>
				</span>
			</a>
			<div class="wsu-header-campus__utility-options">
				<div class="wsu-header-utility-bar ">
					<button class="wsu-header-utility-bar__quicklinks wsu-slide-in-panel--open" data-panel="wsu-quicklinks-panel">
						Quicklinks / Search
